...
public class RabbitMqConfiguration {
    ...
    @Bean
    public Queue monthlyGrossQueue() {
        return new Queue(this.rabbitMqSettings.getQueueMonthlyGross(), this.rabbitMqSettings.isDurable());
    }
    ...
    @Bean
    public Binding monthlyGrossBinding() {
        return BindingBuilder
                .bind(monthlyGrossQueue())
